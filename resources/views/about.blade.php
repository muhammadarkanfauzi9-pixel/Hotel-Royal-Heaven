...
@section('content')
    {{-- HERO SECTION (Specific to About Us as per design) --}}
    {{-- Assuming the user is okay with this specific hero update as it matches the About Us design --}}
    <div class="relative bg-yellow-500 overflow-hidden">
                ...
                <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="sm:text-center lg:text-left">
                        ...
                        <p class="mt-3 text-base text-gray-800 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                            Providing an unforgettable stay experience with a touch of luxury and the best service for each of our guests.
                        </p>
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://images.unsplash.com/photo-1566073771259-6a8506099945?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Hotel Interior">
        </div>
    </div>
